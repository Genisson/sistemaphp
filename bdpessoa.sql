...
--
CREATE DATABASE `bdpessoa` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bdpessoa`;
...
INSERT INTO `tbcontatos` (`id`, `nome`, `idade`, `endereco`) VALUES
...
INSERT INTO `tbusuario` (`id`, `login`, `pass`, `nome`, `perfil`, `ativo`) VALUES
