		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">Cadastro Pessoas</a>
				</div>
		...
		<div class="row">
			<div class="col-md-4">
				<form action="index.php" method="post">
					...
					<input type="submit" name="botao" class="btn btn-primary" value="Acessar">	
				</form>
				<br>
...
<?php
	if(isset($_POST['txtpass'])) 
	{
		...
		$mysqli = new mysqli("localhost", "root", "", "bdpessoa") or die ("Error de conexion porque: ".$mysqli->connect_errno);
		...
		$resultado = $mysqli->query("SELECT * FROM tbusuario where login='$login' and pass='$pass' and ativo!=0");
		$valida=$resultado->num_rows;
		if($valida != 0)
		{
			$datosUsu = $resultado->fetch_row();
			$_SESSION['nomeusu'] = $datosUsu[3];
